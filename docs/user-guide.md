...
| *Локальные порты зондов* | сколько портов свободно и занято. Растущее число ожиданий означает, что [пул мал](parallelism.md#как-проба-выбирает-локальные-порты) для такой нагрузки |
