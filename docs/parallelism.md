...
3. **Возврат.** По завершении замера порт немедленно возвращается в пул, даже
   если замер закончился ошибкой или был прерван.
...
в строке пробы на странице «Пробы»: там видно, сколько портов свободно, занято
и **в карантине**. Растущее число в карантине — верный признак, что
