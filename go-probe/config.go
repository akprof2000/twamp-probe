...
// выбирает ядро.
//
// Значение совпадает с поставляемым appsettings.json, а тот — с настройкой
// ядра net.ipv4.ip_local_port_range из 99-twamp-probe.conf. Совпадение
// намеренное: из этого же диапазона ядро берёт исходящие TCP-соединения, а
// управляющий канал twping нужен каждому замеру TWamp. Подробности и цена
// такого выбора — в docs/parallelism.md.
