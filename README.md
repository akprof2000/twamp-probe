...
| Вкладка | Возможности |
|---|---|
| **Статус проб** | связь/ошибки/backoff, версия пробы, число задач и результатов; кнопка **«задачи»** — живой статус выполнения на пробе (выполняется ли сейчас, последний старт/финиш, счётчик, следующий запуск, последняя ошибка); подтверждение новых проб |
| **Задачи** | список с фильтром, статус, таймаут, колонка **«последний результат»** (успех/ошибка + время), удаление задачи |
...
Все кнопки показывают индикатор ожидания «⏳» на время выполнения операции.
