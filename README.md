...
- **Встроенный отправитель TWampy**: замер идёт прямо в процессе пробы, без запуска python. Такой замер не занимает ни процесса, ни потока ожидания, поэтому предел одновременных замеров на него не распространяется (см. [Сколько замеров одновременно](docs/parallelism.md)).
