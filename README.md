...
| `Start` / `End` | нет | **дата** (`25.12.2026 10:00`) **или длительность** от момента создания. Единицы — английские `year month week day hour min sec` (понимается и опечатка `weak`) и **русские во всех склонениях**: `1 год 2 месяца 2 недели 15 дней`, `2 года 1 неделя день`, `5 лет`, `3 часа 30 минут`. Число можно опускать (единица = 1): `weak`, `year month weak`. Годы и месяцы считаются календарно |
